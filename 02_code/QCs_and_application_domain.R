setwd("C:/Users/.../GitHub/PFOA_semi_quant")
...
directory_with_LOO_models = "C:/Users/.../GitHub/PFOA_semi_quant/models/leave_one_out_approach"
...
QCs_target_data <- read_excel("results/new_suspects_quant/310523_DataForFigures.xlsx", sheet = "QCs", skip = 1) %>% 
...
#suspect SMILES
suspects_SMILES = read_delim("results/new_suspects_quant/suspects_smiles_updated_semicolon2.csv")
