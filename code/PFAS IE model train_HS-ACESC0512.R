...
IE_slope_cor
ggsave(IE_slope_cor, filename =  "221202_logIE_test_train.svg")

ggplotly(IE_slope_cor)
#saveRDS(logIE_pred_model_train_test, file="model_train_test_PFAS_logIE.RData")
...
#saveRDS(logIE_pred_model, file="model_allData_PFAS_logIE.RData")
