...
setwd(admin)
cal_filename_data <-  paste0(admin,"/Lara_suspects_model_quantification/Target PFAS for semiquant_03112022.xlsx")
...
lara_concentrations_pred <- concentration_forAnalytes_model_cal_separateFile(cal_filename_data, 
                                                                             ...
                                                                             filename_eluent = "data/eluent.csv",
                                                                             pred_model =  logIE_pred_model,
                                                                             compounds_to_be_removed_as_list = c("PFHpS-br", "PFPeS", "PFHpS", "PFNS", "PFPeDA", "10:2 mono PAP", "4:2 mono PAP", "6:2 mono PAP", "8:2 mono PAP", "HFPO-DA", "MeFOSE", "EtFOSE"))
...
plot_toSave <- plotly::ggplotly(lara_concentrations_pred$plot_predicted_theoretical_conc)

#htmlwidgets::saveWidget(plot_toSave, "C:/Users/HelenSepman/OneDrive - Kruvelab/Documents/GitHub/PFOA_semi_quant/Lara_suspects_model_quantification/calibrants_real_vs_pred_conc_03112022.html")
...
#ggsave(barplot, filename = paste0(admin,"/Lara_suspects_model_quantification/suspects_summary_byFilename_03112022.svg"), width=40, height=80, units = "cm")
